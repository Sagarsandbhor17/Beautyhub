...
import { Box, Button, Heading, Image, ScaleFade, scaleFadeConfig, SimpleGrid, Text } from '@chakra-ui/react'
...
let data = [
    ...
    {
        id: 4,
        image_link: "https://static.thcdn.com/images/large/webp//productimg/1600/1600/12698965-1624944343556142.jpg",
        name: "EltaMD UV Restore Broad-Spectrum SPF40 Tinted 2 oz",
        price: 41.00,
        review: 1
    },
...
const Suggest = () => {
    return (<div>
        <Heading textAlign={"center"}>Other customers bought:</Heading>
        <br/>
      <SimpleGrid columns={[1, 2, 3, 4]} spacing="40px" >
          {data.map(item => (<Box  w="100%"   padding={["10%","5%","5%","10%"]}>
              <Image src={item.image_link} h="70%" className={style.img} /> 
